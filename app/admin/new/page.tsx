            ...
            if (imageFile) {
                ...
                if (uploadError) {
                    ...
                    if (uploadError.message.includes("Bucket not found") || uploadError.message.includes("row-level security")) {
                        throw new Error("Resim yüklenemedi. Supabase panelinde 'images' adında Public bir Bucket oluşturduğunuzdan emin olun.");
                    }
                ...
                .insert([
                    {
                        ...
                        cover_image: finalImageUrl, // Yüklenen veya girilen URL
                        created_at: new Date(formData.date).toISOString(), // Seçilen tarih
                        published: true,
                    }
                ]);
